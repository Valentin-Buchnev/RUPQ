...
from rupq.models.object_detection.utils.parse_config import parse_model_config
...
class YOLOv3(nn.Module):
    ...
    def __init__(self):
        ...
        dirname = os.path.join(dirname, "models", "object_detection")
        config_path = os.path.join(dirname, "yolo-v3.cfg")  # "./yolo-v3.cfg"
        super().__init__()
        ...
        darknet_weights_path = os.path.join(dirname, "./darknet53.conv.74.ckpt")
        if not os.path.exists(darknet_weights_path):
            _ = wget.download("https://pjreddie.com/media/files/darknet53.conv.74", out=darknet_weights_path)

        self.load_darknet_weights(darknet_weights_path)
