...
if __name__ == "__main__":
    ...
    set_gpu(args.gpu)
    rupq.logger.set_logger()
    rupq.logger.set_logger_logdir(logdir)

    try:
        shutil.copy(args.config, logdir)
    except shutil.SameFileError:
        logger = rupq.logger.get_logger()
        logger.warning("Experiment file already exists in the folder")
